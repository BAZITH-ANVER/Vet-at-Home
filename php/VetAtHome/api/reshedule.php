 ...
 <body>  
  ...
  <form action=""method="POST"><br>
  	<center><h2><b><p style = "color:green">Resheule Request</p></b></h2></center>
	     <label>Patient Name:</label><input type="text" value="<?php echo $row['patient_id'];  ?>"  name="uid" class='form-control'><br>
   ...
   <input type="hidden" name="did" value='<?php echo $_REQUEST['id'] ?>'>
     ...
     error_reporting(0);
       ...
       if(isset($_POST['submit']))
       {
        ...
        $ins="INSERT INTO reshedule(patient_id,doctor_id,date,time) VALUES('$u','$d','$date','$time')";
